    ...
    "inline-flex items-center border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none",
    {
        variants: {
            variant: {
                ...
                sage: "border-transparent bg-sage text-foreground",
                rose: "border-transparent bg-rose text-foreground",
                lavender: "border-transparent bg-lavender text-foreground",
                cream: "border-transparent bg-cream text-foreground",
            },
        },
        defaultVariants: {
            variant: "default",
