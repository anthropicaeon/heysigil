    ...
    return (
        <section className="bg-background relative overflow-hidden px-2.5 lg:px-0">
            <div className="relative container px-0 bg-obsidian">
                ...
                <div className="border-dark-gray flex items-center justify-center border border-t-0 px-6 py-8 lg:px-8 lg:py-20">
                    <div className="flex w-full max-w-lg flex-col items-center gap-4 text-center lg:gap-6">
                        ...
                        <p className="text-mid-gray text-base">
                            From real-time balances to in-app support, these tools let you see,
                            move, analyze and act on your company’s money—all in one place.
                        </p>
                    </div>
                </div>
                ...
                <div
                    className={cn(
                        "border-b-dark-gray border-l-dark-gray border-r-dark-gray relative video w-full border",
                        !isPlaying &&
