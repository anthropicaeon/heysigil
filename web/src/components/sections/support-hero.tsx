                ...
                <div className="grid gap-12 py-12 lg:grid-cols-[1fr_auto] lg:py-20 lg:pl-12">
                    <div className="flex flex-col items-start justify-center gap-5 lg:gap-8">
                        ...
                        <p className="text-mid-gray max-w-lg text-base">
                            Get answers without breaking your flow. Our built-in chat connects you
                            directly to FinSight specialists who can troubleshoot issues, guide new
                            workflows, and share best-practice tips—all from inside the dashboard
                            and typically within minutes.
                        </p>
                    </div>
