...
import type { ChallengeResponse, CheckResult, ClaimResult, WalletInfo, FeeInfo, ProjectInfo } from "@/types";

const BASE_URL = process.env.NEXT_PUBLIC_API_URL || "http://localhost:3001";

// Re-export types for convenience
export type { ChallengeResponse, CheckResult, ClaimResult, WalletInfo, FeeInfo, ProjectInfo };
