...
import { verifyProof as reclaimVerifyProof, type Proof as ReclaimProof } from "@reclaimprotocol/js-sdk";
...
async function verifyReclaimProof(
  ...
  try {
    ...
    return {
      ...
      method: "tweet_zktls",
      projectId,
      error: `Reclaim proof verification failed: ${err instanceof Error ? err.message : "unknown SDK error"}`,
    };
  }
