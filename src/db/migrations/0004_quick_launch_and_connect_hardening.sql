ALTER TABLE "connected_bots" ADD COLUMN "provisioner" varchar(32);--> statement-breakpoint
ALTER TABLE "connected_bots" ADD COLUMN "provision_status" varchar(32);--> statement-breakpoint
ALTER TABLE "connected_bots" ADD COLUMN "provision_project_id" varchar(128);--> statement-breakpoint
ALTER TABLE "connected_bots" ADD COLUMN "provision_service_id" varchar(128);--> statement-breakpoint
ALTER TABLE "connected_bots" ADD COLUMN "provision_deployment_id" varchar(128);--> statement-breakpoint
...
CREATE UNIQUE INDEX "quick_launch_ip_guardrails_hash_uq" ON "quick_launch_ip_guardrails" USING btree ("ip_hash");--> statement-breakpoint
...
CREATE INDEX "connect_quick_launches_user_idx" ON "connect_quick_launches" USING btree ("user_id","created_at");
